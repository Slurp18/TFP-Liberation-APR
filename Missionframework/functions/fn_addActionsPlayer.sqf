...
_player addAction[
    [["<t color='#FF0000'>", localize "STR_GARBAGE_CLEAN_ACTION", "</t> <img size='2' image='res\ui_garbage.paa'/>"]
    {[player getVariable ["KPLIB_fobPos", [0, 0, 0]], KPLIB_range_fob * 0.9, player] call KPLIB_fnc_garbage_clean;},
    nil,
    -850,
    false,
    true,
